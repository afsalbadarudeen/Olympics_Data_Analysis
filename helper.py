...
def fetch_medal_tally(df, year, country):
    ...
    if flag == 1:
        x = temp_df.groupby("Year").sum()[['Silver', 'Gold', 'Bronze']].sort_values('Year',
                                                                                    ascending=True).reset_index()
    else:
        x = temp_df.groupby("region").sum()[['Silver', 'Gold', 'Bronze']].sort_values('Gold',
...
def medal_tally(df):
    ...
    medal_tally = medal_tally.groupby("NOC").sum()[['Silver', 'Gold', 'Bronze']].sort_values('Gold',
                                                                                             ascending=False).reset_index()
